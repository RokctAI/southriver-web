...
// hands-on mode. Composing agent_sdk installs the chat surface and its
// manifest injects `agent: true,` at the marker, flipping the shell AI-first;
// a shell that must stay hands-on leaves agent_sdk out of its composition.
