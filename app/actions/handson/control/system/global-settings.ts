 ...
 * import it and stay buildable with only base_sdk composed: the seam
 * answers with the platform defaults and reports toggles as unavailable
 * rather than pretending they applied. A shell that composes auth_sdk can
 * widen this seam to call the composed control-plane service.
 */
